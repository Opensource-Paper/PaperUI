...
class MediaCheckbox extends HTMLElement {
  static get observedAttributes() {
    return ['theme', 'style'];
  }
  ...
  applyTheme() {
    if (this.hasAttribute('theme')) {
      this.applyCustomTheme();
    } else if (paperui && paperui.mediacheckbox && paperui.mediacheckbox.theme) {
      this.theme = paperui.mediacheckbox.theme;
      this.applyCustomTheme();
    } else {
      this.applyDefaultTheme();
    }
...
class MediaSearch extends HTMLElement {
  static get observedAttributes() {
    return ['theme', 'style'];
  }
  ...
  applyTheme() {
    if (this.hasAttribute('theme')) {
      this.applyCustomTheme();
    } else if (paperui && paperui.mediasearch && paperui.mediasearch.theme) {
      this.theme = paperui.mediasearch.theme;
      this.applyCustomTheme();
    } else {
      this.applyDefaultTheme();
    }
